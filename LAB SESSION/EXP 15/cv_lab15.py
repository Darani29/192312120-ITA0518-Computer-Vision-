...
Original file is located at
    https://colab.research.google.com/drive/1BMpt0MSfmHZrcfNQjL38dp2u-M0wE6hd
"""
...
# Draw circles
cv2.circle(img, (100,100), 8, (255,0,0), -1)
cv2.circle(img, (400,100), 8, (255,0,0), -1)
cv2.circle(img, (400,400), 8, (255,0,0), -1)
cv2.circle(img, (100,400), 8, (255,0,0), -1)

# Add text
cv2.putText(img, "DLT", (180,260),
